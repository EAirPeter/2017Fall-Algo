...
int main() {
    ...
    DataA(fo, {39990, 40000}, {0, 19999999900}, 100);
    DataB(fo, {39990, 40000}, {0, 19999999900}, 100);
    DataC(fo, {39990, 40000}, {0, 19999999900}, 100);
    DataA(fo, {39990, 40000}, {0, 19999999990}, 10);
    DataB(fo, {39990, 40000}, {0, 19999999990}, 10);
    DataC(fo, {39990, 40000}, {0, 19999999990}, 10);
    DataA(fo, {39990, 40000}, {0, 20000000000}, 0);
    DataB(fo, {39990, 40000}, {0, 20000000000}, 0);
    DataC(fo, {39990, 40000}, {0, 20000000000}, 0);
    DataD(fo, {39990, 40000}, {0, 20000000000}, 0);
    DataD(fo, {39990, 40000}, {0, 20000000000}, 1);
    DataD(fo, {39990, 40000}, {0, 20000000000}, 2);
    return 0;
}
